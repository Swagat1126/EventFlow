        ...
        <div className="min-h-screen bg-cover bg-center relative"
            ...
            <div className="relative z-10 flex items-center justify-center min-h-screen px-4">
                ...
                <motion.div
                    ...
                    className="w-full max-w-md bg-white/20 backdrop-blur-lg p-8 rounded-2xl shadow-2xl"
                >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3">
                        ...
                        <div> <label className="text-sm text-white">Role*</label>
                        ...
                        {errors.terms &&
                            <p className="text-red-300 text-xs">{errors.terms}</p>}
